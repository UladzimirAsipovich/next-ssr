...
archive.file('.env.development.local');
archive.file('.env.local');
archive.file('.env.production.local');
archive.file('.eslintrc.json');
archive.file('.ftpqouta');
archive.file('.htaccess');
archive.file('next-env.d.ts');
archive.file('next.config.js');
archive.file('package.json');
archive.file('postcss.config.json');
archive.file('prettier.config.json');
